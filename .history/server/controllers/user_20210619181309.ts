...
export function displayEditPage (req:Request,res:Response,next:NextFunction): void {
    ...
    Contact.findById(id, (err:Error, contactToEdit: any) => {
        if (err) 
        {
            console.log(err);
            res.end(err);
        ...
        {
            // show the edit view
            res.render('users/edit', {title: 'Edit Contact', contact: contactToEdit})
        }
...
export function processEditPage (req:Request,res:Response,next:NextFunction): void {
    ...
    Contact.updateOne({"_id": id}, updateUser, (err: Error) => {
        if (err) 
        {
            console.log(err);
            res.end(err);
